...
Данный Telegram-бот предоставляет актуальные курсы обмена валют и выполняет конвертацию валют на основе пользовательского ввода. Теперь бот дополнен **графиками курсов, автоуведомлениями, подпиской на ежедневные обновления, возможностью просмотра установленных будильников** и функцией отображения **лучших обменников в Ижевске**.
...
- ✅ Отображение текущих курсов популярных валют (**USD, EUR, JPY, TRY, RUB**).  
...
- ✅ Отображение **лучших обменников в Ижевске** – бот генерирует график с топ-10 обменных пунктов по курсам покупки и продажи.
...
- **📋 Мои будильники** – Просмотр списка установленных будильников.  
- **📊 Лучшие обменники в Ижевске** – Отображение графика с лучшими курсами обмена в Ижевске.

### 🔹 **Пример использования конвертации**

1. Пользователь: **`/start`**  
2. Бот: "👋 Добро пожаловать! Выберите действие:"  
   - Кнопки: **[USD] [EUR] [JPY] [TRY] [RUB]**, а также дополнительные функции.
...
3. Для просмотра всех установленных будильников пользователь нажимает кнопку **📋 Мои будильники** (или команду **`/myalerts`**), после чего бот выводит список с возможностью удаления любого будильника командой **`/delete_alert <номер>`**.

### 🔹 **Пример отображения лучших обменников в Ижевске**

1. Пользователь нажимает кнопку **📊 Лучшие обменники в Ижевске**.  
2. Бот собирает данные с сайта banki.ru и формирует график, на котором показаны топ-10 обменных пунктов с курсами покупки и продажи, после чего отправляет его пользователю.
